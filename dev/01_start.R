...
##
golem::fill_desc(
  pkg_name = "sspLNIRT", # The name of the golem package containing the app (typically lowercase, no underscore or periods)
  pkg_title = "Sample Size Planning for Joint Hierarcical Modelling using LNIRT", # What the Package Does (One Line, Title Case, No Period)
