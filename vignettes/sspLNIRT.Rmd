...
precision of item parameter estimates, given the assumed data-generating
process?* Precision is defined as the root mean squared error (RMSE) of a
...
Having established that the target precision for $\alpha$ is reached, I can check
the other precisions in the output. All other item parameters are below my RMSE 
...
`plot_precision()` shows how RMSE or bias varies across the range of true
