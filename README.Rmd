...
`sspLNIRT` is a sample size planning tool for item calibration with the Joint Hierarchical Model (JHM) of response accuracy and response time. It estimates the minimum sample size required to achieve a target precision (RMSE) of item parameter estimates under a specified data-generating process.
...
- **Visualization functions** for inspecting parameter precision or bias, power curves, and implied response time and response accuracy distributions.
